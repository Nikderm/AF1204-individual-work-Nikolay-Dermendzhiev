...
def _(
    ...
    fig_3d_firmsize = px.scatter_3d(
        ...
        color='Name',
        hover_name='Name',
        title=f'{dataset_label}: 3D Firm Size Credit Risk Analysis',
        labels={'Market_Cap_B': 'Market Cap (Billion $)'},
        width=900,
        height=600
    )
...
def _(
    ...
    # --- Tab 2d: Competition Analysis ---
    tab_competition_analysis = mo.md(
        """
        ## Competition Analysis

        Compare AFKLM with its peers and show the competitive landscape.
        Include metrics, strengths, weaknesses, or market positioning here.
        """
    )

    # --- Tab 2e: Future Outlook ---
    tab_future_outlook = mo.md(
        """
        ## Future Outlook

        Add your perspectives on AFKLM's future growth, market trends, and strategic direction.
        Highlight expected opportunities and long-term potential.
        """
    )
    ...
    tab_passion_projects = mo.ui.tabs({
        ...
        "Competition Analysis": tab_competition_analysis,
        "Future Outlook": tab_future_outlook,
...
@app.cell
def _(mo, tab_ai, tab_csv, tab_passion_projects, tab_personal, tab_search):
